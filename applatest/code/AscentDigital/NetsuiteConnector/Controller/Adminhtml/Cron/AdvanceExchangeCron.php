...
class AdvanceExchangeCron extends \Magento\Backend\App\Action
{
    // protected$logger;
    ...
    public function processSearchResponse($searchResponse, $logger)
    {
        ...
        foreach ($cases as $case) {
            try {
                ...
                $logger->critical(__('AscentDigital\NetsuiteConnector\Controller\Adminhtml\Cron\AdvanceExchangeCron' . $ex->getMessage()));
            }
        }
    }
