...
class GetAllOrder
{
    ...
    public function execute()
    {
        ...
        $logger->info('GetAllOrder cron is running');
        die('cron');
        $storeId = 1;
        //stating frontend environment emulation
        $this->emulation->startEnvironmentEmulation($storeId, 'frontend');
        //creating custom log netsuite_cron.log 
