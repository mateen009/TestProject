...
class OrderStatusReport extends \Magento\Sales\Block\Order\History
{
    /**
     * @var string
     */
    protected $_template = 'AscentDigital_Reports::orderstatusreport.phtml';
    ...
    public function __construct(
        ...
        \AscentDigital\Reports\Helper\ExportOrderStatusReport $exportHelper,
        \AscentDigital\Reports\Helper\Pdf\OrderStatusPdf $generatePdf,
    ...
    {
        return $this->_storeManager->getStore()->getUrl("mobilecg/salesmanager/orderstatusreport");
    }
    ...
    public function getOrders()
    {
       ...
       // echo "<pre>";print_r($_REQUEST);echo "</pre>";
        ...
        if (strpos($this->request->getParam('status'), $baseUrl.'mobilecg/salesmanager/orderstatusreport/') !== false) {
            $orderStatus = trim(str_replace($baseUrl."mobilecg/salesmanager/orderstatusreport/", "", $this->request->getParam('status')));
        }
        ...
        if (strpos($this->request->getParam('status'), $baseUrl.'mobilecg/salesmanager/orderstatusreport/?status=') !== false) {
            $orderStatus = trim(str_replace($baseUrl."mobilecg/salesmanager/orderstatusreport/?status=", "", $this->request->getParam('status')));
        }
