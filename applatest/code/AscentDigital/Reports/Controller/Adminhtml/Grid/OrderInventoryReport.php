...
class OrderInventoryReport extends Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Order Inventory Report'));
        $resultPage->addBreadcrumb(__('Reports'), __('Order Inventory Report'));
        return $resultPage;
