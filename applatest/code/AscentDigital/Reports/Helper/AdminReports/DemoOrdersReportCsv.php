...
class DemoOrdersReportCsv extends AbstractHelper
{
    ...
    public function generateCSV()
    {
        ...
        $header = ['SO #', 'Email', 'Agency Name','Sku', 'Item Name', 'Date', 'Due Date'];
        $stream->writeCsv($header);

        $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        $ordersBlock = $objectManager->get('AscentDigital\Reports\Block\Adminhtml\Reports\DemoOrders');
