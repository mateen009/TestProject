...
class OrderCheckDemoPdf extends AbstractHelper{
    /** @var ResultFactory */
    ...
    public function generate($orders)
    {
            ...
            $pdf->SetTitle('Orders Checked Out for Demo');
            $pdf->SetSubject('Orders Checked Out for Demo');
            $pdf->SetKeywords('Orders Checked Out for Demo');
        ...
        $heading='<h1>Orders Checked Out for Demo</h1>';
            ...
            <tr>
            <td><span>Due Date:  '.date('M d, Y', strtotime($order->getDueDate())).'</span></td>
            </tr>
            </table>
            ...
            //CHM file name
            $search = array('/', '"');
            $file_n = str_replace('Orders Checked Out for Demo', "", 'Orders Checked Out for Demo' . '-' . '' . '.pdf');
