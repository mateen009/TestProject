...
class OrderDetailPdf extends AbstractHelper{
    /** @var ResultFactory */
    ...
    public function generate($orders)
    {
            ...
            $pdf->SetAuthor('American Fire Glass');
            ...
            <tr>
            <td><span>Sales Rep Email:  '.$order->getCustomerEmail().'</span></td>
            </tr>
            <tr>
           ...
           $pdf->writeHTML($html, true, false, true, false, '');
            ...
            //CHM file name
            $search = array('/', '"');
            $file_n = str_replace('Order Detail Report', "", 'Order Detail Report' . '-' . '' . '.pdf');
