...
class OrderDueBackPdf extends AbstractHelper{
    /** @var ResultFactory */
    ...
    public function generate($orders)
    {
           $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
            ...
            $heading='<h1>Due Back Order Report</h1>';
            ...
            <tr>
            <td><span>Return Status:  '.$order->getReturnStatus().'</span></td>
            </tr>
            </table>';
           ...
           $pdf->writeHTML($html, true, false, true, false, '');
            ...
            //CHM file name
            $search = array('/', '"');
            $file_n = str_replace('Due Back Order Report', "", 'Due Back Order Report' . '-' . '' . '.pdf');
