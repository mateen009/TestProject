...
class OrderSalesPdf extends AbstractHelper{
    /** @var ResultFactory */
    ...
    public function generate($orders)
    {
           $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
            ...
            $pdf->SetTitle('Sales by Sales Rep');
            $pdf->SetSubject('Sales by Sales Rep');
            $pdf->SetKeywords('Sales by Sales Rep');
           ...
           $heading='<h1>Sales by Sales Rep</h1>';
           ...
           <tr>
           <td><span>Due Order:  '.$orderData.'</span></td>
           </tr>
           </table>
           ...
           $pdf->writeHTML($html, true, false, true, false, '');
            ...
            //CHM file name
            $search = array('/', '"');
            $file_n = str_replace('Sales by Sales Rep', "", 'Sales by Sales Rep' . '-' . '' . '.pdf');
