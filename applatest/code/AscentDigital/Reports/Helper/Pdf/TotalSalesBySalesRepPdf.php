...
class TotalSalesBySalesRepPdf extends AbstractHelper{
    /** @var ResultFactory */
    ...
    public function generate($orders)
    {
           ...
           $heading='<h1>Total Sales By Sales Rep Report</h1>';
           ...
           <tr>
           <td><span>Total Orders:  '.$blockViewOrder->getOrderCount($order->getCustomerEmail()).'</span></td>
           </tr>
           <tr>
           <td><span>On Demo:  '.$blockViewOrder->getDemoOrderCount($order->getCustomerEmail()).'</span></td>
           </tr>
           <tr>
           <td><span>Due:  '.$blockViewOrder->getLateOrderCount($order->getCustomerEmail()).'</span></td>
           </tr>
           <tr>
           <td><span>Compeleted:  '.$blockViewOrder->getCompletedOrderCount($order->getCustomerEmail()).'</span></td>
           </tr>
           <tr>
           <td><span>Total Qty Ordered:  '.number_format($order->getTotalQtyOrdered()).'</span></td>
           </tr>
           </table>
            ...
            //CHM file name
            $search = array('/', '"');
            $file_n = str_replace('Total Sales By Sales Rep Report', "", 'Total Sales By Sales Rep Report' . '-' . '' . '.pdf');
