...
class Related extends RelatedParent {
    ...
    protected function getCustomlinkedFieldset($modify) {
        $content = __(
                'These Products are shown under the Master Product.'
        );
        return [
            'children' => [
                'button_set' => $modify->getButtonSet(
                        $content, __('Add Master Linked Products'), $modify->scopePrefix . static::DATA_SCOPE_CUSTOMLINKED
                ),
                'modal' => $this->getGenericModal(
                        __('Add Master Linked Products'), $modify->scopePrefix . static::DATA_SCOPE_CUSTOMLINKED
                ),
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'label' => __('Master Linked Products'),
                        'collapsible' => false,
