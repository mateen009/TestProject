...
use Magenest\RentalSystem\Model\RentalRule\Condition\Combine as CombinedCondition;
...
class MappableConditionsProcessor
{
    ...
    private function rebuildCombinedCondition(CombinedCondition $originalConditions): CombinedCondition
    {
        ...
        foreach ($originalConditions->getConditions() as $condition) {
            ...
            if (in_array($condition->getType(), [SimpleCondition::class, Product::class])) {
     ...
     */
    private function validateSimpleCondition($originalConditions): bool
    {
