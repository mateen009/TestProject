define([
    ...
    var email_menu = function(magezonBuilderUrl, magezonBuilderService, magezonBuilderFilter) {
        return {
            replace: true,
            templateUrl: function(elem) {
                return magezonBuilderUrl.getTemplateUrl(elem, 'Magezon_EmailBuilder/js/templates/builder/element/menu.html');
            },
