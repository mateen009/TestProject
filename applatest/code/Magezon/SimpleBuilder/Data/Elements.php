...
namespace Magezon\SimpleBuilder\Data;
...
class Elements
{
    ...
    public function __construct(
        ...
        \Magezon\SimpleBuilder\Model\ElementFactory $elementFactory,
        array $elements = []
    ) {
    ...
    public function getElements()
    {
        if ($this->sortableElements == null && $this->elements) {
            ...
            foreach ($elements as $type => $data) {
                if (!isset($data['class'])) $data['class'] = 'Magezon\SimpleBuilder\Data\Element\Element';
