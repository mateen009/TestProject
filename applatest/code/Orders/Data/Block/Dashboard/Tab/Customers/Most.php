 ...
 */
namespace Orders\Data\Block\Dashboard\Tab\Customers;
 ...
 * @since 100.0.2
 */
class Most extends \Magento\Backend\Block\Dashboard\Tab\Customers\Most
{
    /**
    ...
    protected function _prepareColumns()
    {
        ...
        if ($this->getParam('store') && $this->getParam('store') == 2) {
          $this->removeColumn(
            'orders_avg_amount',
            [
                'header' => __('Average'),
    ...
    public function getStoreId($row)
    {
      $store_id = $row->getStoreId();
      if ($this->getParam('store')) {
        $store_id = $this->getParam('store');
      }
        return $store_id ;
    }
}
