...
class Paystand extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        // custom work by mateen
        $order->setPaystandPaymentId($json->resource->id);
        $order->setPaystandPaymentStatus($json->resource->status);
        $order->setPaystandNsidStatus('not_updated');
