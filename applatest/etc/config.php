...
return [
    'modules' => [
        ...
        'AscentDigital_Checkout' => 1,
        'AscentDigital_MenuItem' => 1,
        'AscentDigital_MfgPartNumber' => 1,
        'AscentDigital_NetsuiteConnector' => 1,
        'AscentDigital_OrderApproval' => 1,
        'AscentDigital_PayStandCron' => 1,
        'AscentDigital_Reports' => 1,
        'AscentDigital_SalesForce' => 1,
        'AscentDigital_ShippingMethod' => 1,
        'Cg_Backend' => 1,
        'Checkout_Fields' => 1,
        'Cminds_Oapm' => 1,
        'Cpm_UseMyTerm' => 0,
        'Custom_AdvanceExchange' => 1,
        'Customs_Custom' => 1,
        'Experius_EmailCatcher' => 1,
        'Ibnab_CustomLinked' => 1,
        'Magenest_Core' => 1,
        'Magenest_RentalSystem' => 1,
        'Mageplaza_Core' => 1,
        'Mageplaza_DeleteOrders' => 1,
        'Mageplaza_Smtp' => 1,
        'Magezon_Core' => 1,
        'Magezon_Builder' => 1,
        'Magezon_SimpleBuilder' => 1,
        'Magezon_EmailBuilder' => 1,
        'Mobility_Base' => 1,
        'Mobility_CategoryTnCPopup' => 1,
        'Mobility_CustomerLogin' => 1,
        'Mobility_DemoReminder' => 1,
        'Mobility_ForceCustomerLogin' => 1,
        'Mobility_OutOfOfficeApprovals' => 1,
        'Mobility_QuoteRequest' => 1,
        'Mobility_SalesTeamManagement' => 1,
        'OlegKoval_RegenerateUrlRewrites' => 1,
        'Orders_Data' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'PayStand_PayStandMagento' => 1,
        'PerksAtWork_Homepage' => 1,
        'PerksAtWork_NextJumpSFTP' => 1,
        'PerksAtWork_Popup' => 1,
        'Punchout2Go_Punchout' => 1,
        'Temando_ShippingRemover' => 1,
        'TradeCentric_Version' => 1
    ]
];
